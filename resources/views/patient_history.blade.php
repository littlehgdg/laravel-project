        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Patient History</h6>
          ...
          <div class="col-lg-8">
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <div class="info-row">
                          <span class="info-label">Nama:</span> {{ $patient->fname }} {{ $patient->lname }}
                      </div>
                      <div class="info-row">
                          <span class="info-label">Umur:</span> {{ $patient->age }}
                      </div>
                      <div class="info-row">
                          <span class="info-label">Gender:</span> {{ $patient->gender}}
                      </div>
                      <div class="info-row">
                          <span class="info-label">Phone/Email:</span> {{ $patient->phone_number }}/{{ $patient->email }}
                      </div>
                      <div class="info-row">
                          <span class="info-label">Alamat:</span> {{ $patient->address }}
                      </div>                       
