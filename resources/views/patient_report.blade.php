                ...
                <div class="header-body">
                    <div class="row align-items-center py-4">
                        <div class="col-lg-6 col-7">
                            <h6 class="h2 text-white d-inline-block mb-0">Patient Report</h6>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            ...
                            <form method="GET" action="{{ route('patient_report') }}">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <table class="table align-items-center table-flush">
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            {{-- <td>
                                                <a class="btn btn-sm btn-info" href="{{ route('patient_history', $patient->id) }}">View History</a>
                                            </td> --}}
                                        </tr>
                                        @endforeach
                                    </tbody>
