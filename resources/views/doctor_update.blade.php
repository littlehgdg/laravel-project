            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Edit Data Doctor</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <a href="{{ url('doctor_show') }}" class="btn btn-sm btn-neutral">Back</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Update Profile Doctor</h3>
                </div>
              </div>
            </div>
            <div class="card-body">
              <form method="POST" action="{{ url('doctor_update', $doctor->id) }}">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Name" name="name" required value="{{ $doctor->name }}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-control-label" for="input-speciality">Speciality</label>
                                <input class="form-control" type="text" placeholder="Speciality" name="speciality" required value="{{ $doctor->speciality }}">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Home Address" name="address" required value="{{ $doctor->address }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Contact" name="phone_number" required value="{{ $doctor->phone_number }}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-control-label" for="input-email">E-mail</label>
                                <input class="form-control" type="email" placeholder="abc@example.com" name="email" required value="{{ $doctor->email }}">
                            </div>
                        </div>
                    </div>
                </div>
