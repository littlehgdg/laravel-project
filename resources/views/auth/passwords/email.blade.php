        ...
        <div class="container">
            ...
            <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a href="{{ url('/login/admin') }}" class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{ route('login') }}" class="nav-link">
                            <span class="nav-link-inner--text">Employee Login</span>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                            ...
                            <p class="text-lead text-white">Enter your email to reset your password.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-5 col-md-7">
                    <div class="card bg-secondary border-0 mb-0">
                        <div class="card-header bg-transparent pb-5">
                            <div class="text-muted text-center mt-2 mb-3"><small>Reset your password with</small></div>
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            <div class="text-center text-muted mb-4">
                                <small>Or enter your email below</small>
                            </div>
