            ...
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="nama_bangsal">Ward Name</th>
                    <th scope="col" class="sort" data-sort="tipe_bed">Bed Type</th>
                    <th scope="col" class="sort" data-sort="doctor_id">Doctor ID</th>
                    <th scope="col" class="sort" data-sort="patient_id">Patient ID</th>
                ...
                <tbody class="list">
                  ...
                  <tr>
                    <td>{{ $ward->id }}</td>
                    <td>{{ $ward->nama_bangsal }}</td>
                    <td>{{ $ward->tipe_bed }}</td>
                    <td>{{ $ward->doctor_id }}</td>
                    <td>{{ $ward->patient_id }}</td>
                    <td>
                      <form method="POST" action="{{ url('ward_delete/'.$ward->id) }}" style="display:inline;">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-sm btn-danger" type="submit">Delete</button>
                      </form>
                      <a class="btn btn-sm btn-neutral" href="{{ url('ward_edit/'.$ward->id) }}">Edit</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
