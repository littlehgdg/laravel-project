      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST" action="{{ url('doctor_store') }}">
                @csrf
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-department">Speciality</label>
                        <input class="form-control" type="text" placeholder="Speciality" name="speciality" required>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Home Address" name="address" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Contact" name="phone_number" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">E-mail</label>
                        <input class="form-control" type="email" placeholder="abc@example.com" name="email" required>
                      </div>
                    </div>
                  </div>
                </div>
