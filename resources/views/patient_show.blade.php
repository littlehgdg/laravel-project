              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="phone_number">Contact</th>
                    <th scope="col" class="sort" data-sort="email">E-mail</th>
                    <th scope="col" class="sort" data-sort="address">Address</th>
                    <th scope="col" class="sort" data-sort="description">Medical History</th>
                ...
                <tbody class="list">
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-sm btn-info" href="{{ route('patient_history', $patient->id) }}">Lihat Document</a>
                    </td>
                    <td>
                      <a class="btn btn-sm btn-danger" href="{{ route('patient_delete', $patient->id) }}">Delete</a>
                      <a class="btn btn-sm btn-neutral" href="{{ route('patient_edit', $patient->id) }}">Edit</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
