              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="speciality">Speciality</th>
                ...
                <tbody class="list">
                  ...
                  <tr>
                    ...
                    <td>         
                      <form action="{{ route('doctor_delete', $doctor->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-sm btn-danger">Delete</button>
                        <a class="btn btn-sm btn-info" href="{{ route('doctor_edit', $doctor->id) }}">Edit</a>
                      </form>
                    </td>
                  </tr>
                  @endforeach
